...
jurassic_world_fallen_kingdom = media.Movie("Jurassic World: Fallen Kingdom",
...
star_wars_han_solo = media.Movie("Solo: A Star Wars Story",
...
the_predator = media.Movie("The Predator",
